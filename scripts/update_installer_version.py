...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=AmpMod Demo Installer\n"
      else:
        line="OutputBaseFilename=AmpMod Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the AmpMod Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the AmpMod installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=AmpMod Demo installer\n"
     else:
       line="SetupWindowTitle=AmpMod installer\n"
