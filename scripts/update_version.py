...
def main():
  ...
  plistpath = scriptpath + "/resources/AmpMod-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AmpMod-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AmpMod-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AmpMod-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AmpMod-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/AmpMod.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/AmpMod.iss",inplace=1):
